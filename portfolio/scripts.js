var projectlist = [
  '<span style="color: burlywood">-film-</span> <br>',
  ...
  transition(function () {
    switch (selectedProject) {
      ...
      case 6:
        ...
        $('.info_text')[0].innerHTML = "Stop Motion Wars is a group project with Darien Campo and Rodney Cuda. The whole project was split evenly between animating and photography; post-processing was my responsibility. Lego characters and vehicles were used as affordable props and they were fun characters to animate. The video is an encounter between a Jedi on a Speeder and a Stormtrooper in a TIE fighter.";
        break;
      ...
      case 31:
        $('.projButtons')[0].innerHTML = '<span id="prev" onclick="projClick(30)">prev</span> <span id="back" onclick="pT()">back</span> <span id="next" style="color: gray">next</span>';
